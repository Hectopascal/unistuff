...
int tritest(double x0,double y0,double x1,
            double y1,double x2,double y2,double px, double py); 
int test1(double px, double py, double m,
...
// get input
    ...
    aggregateValue += scanf("%lf,%lf", &x0,&y0);
    printf("Triangle Vertex  B (x,y): "); 
    aggregateValue += scanf("%lf,%lf", &x1,&y1);
    printf("Triangle Vertex  C (x,y): "); 
    aggregateValue += scanf("%lf,%lf", &x2,&y2);
    printf("Test Point (x,y): "); 
    aggregateValue += scanf("%lf,%lf", &px,&py);
